...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jun 01 18:24:53 CEST 2016
  */
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
		...
		Object v = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 ...
		 System.out.println("IF"); 
          ...
          case 7: // composit_statement ::= statement 
            {
              Object RESULT =null;
		 ArrayList<Node<String>> ll = new ArrayList<Node<String>>(); Node<String> st =new Node<String> ("Statement");  ll.add(st); RESULT=ll; System.out.println("STATEMENT"); 
	...
	ArrayList<Node<String>> new_ll = (ArrayList<Node<String>>) ll;
	ArrayList<Node<String>> new_cl = (ArrayList<Node<String>>) cl;
	//if(new_ll != null) {
		new_cl.add(new_ll.get(0));
	//}
 	RESULT=new_cl; 
		...
		int vright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Object v = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 System.out.println("Package"); Node<String> pack=new Node<String>("package"); Node<String> identifier =new Node<String>("Identifier"); String value = (String) v; identifier.addChild(value,identifier); pack.addChild(identifier,pack); RESULT=pack;  
	...
	//System.out.println(pr.getChildren().get(0).getChildren().get(0).getData()); 
	//System.out.println("Parent data: " + pr.getParent().getData());  
	...
	//System.out.println(radice.getChildren().get(i).getData());
	System.out.println(radice.getChildren().get(i).getChildren().size());
         /*for(int j=0; j<radice.getChildren().get(i).getChildren().size();j++){
		System.out.println(radice.getChildren().get(i).getChildren().get(j));
		}*/
	}
	System.out.println("------------------------------------");
