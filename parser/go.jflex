...
<YYINITIAL> "package"                { return symbol(sym.PACKAGE); }
 ...
 <YYINITIAL> {
	...
	"&^="	{ return symbol(sym.ANDCAPEQ); }
      ...
      {Imaginary_lit}                { return symbol(sym.IMAGINARY_LITERAL,yytext()); }
      {Hex_lit}                      { return symbol(sym.HEX_LITERAL,yytext()); }
      {Decimal_lit}                  { return symbol(sym.DECIMAL_LITERAL,yytext()); }
      {Octal_lit}                    { return symbol(sym.OCTAL_LITERAL,yytext()); } 
      {Float_lit}                    { return symbol(sym.FLOAT_LITERAL,yytext()); }
