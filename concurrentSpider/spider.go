...
func main() {
	...
	totalURLCount = 0
	urls = append(urls, "https://en.wikipedia.org/wiki/Paterson_Islands")
	urls = append(urls, "https://en.wikipedia.org/wiki/Dalpiazia")
	//urls = append(urls, "https://en.wikipedia.org/wiki/Vasyl_Pryima")
	//urls = append(urls, "https://en.wikipedia.org/wiki/Sauda_Church")
	//urls = append(urls, "https://en.wikipedia.org/wiki/Gordon_Rich-Phillips")
